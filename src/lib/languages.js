export const languages = {
  ...
  fr: {
    ...
    aboutContent: 'Développée et maintenue par ',
    aboutContent1:'The Commons Project',
    aboutContent2:', cette ',
    aboutContent3: 'application open source',
    aboutContent4: ' peut être utilisée de manière autonome ou intégrée dans un DSE pour lire les informations contenues dans les ',
    aboutContent5:' cartes de santé et les liens SMART.',
    aboutContent6:' Les types de données pris en charge comprennent actuellement les ', 
    aboutContent7:' cartes de vaccination contre la COVID-19,',
    aboutContent8:' les dossiers généraux de vaccination, les ', 
    aboutContent9:' résumés internationaux de dossiers de patients,', 
    aboutContent10: " et les cartes numériques d'assurance maladie. ",
    aboutContact1:'The Commons Project.',
