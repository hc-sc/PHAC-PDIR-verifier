export const languages = {
  ...
  fr: {
    ...
    aboutContent4: ' peut être utilisée de manière autonome ou intégrée dans un DSE pour lire les informations contenues dans ',
    aboutContent5:'les cartes de santé et les liens SMART.',
    aboutContent6:' Les types de données pris en charge comprennent actuellement ', 
    aboutContent7:'les cartes de vaccination contre la COVID-19,',
    aboutContent8:' les dossiers généraux de vaccination, ', 
    aboutContent9:'les résumés internationaux de dossiers de patients,', 
